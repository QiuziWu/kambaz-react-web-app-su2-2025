            ...
            <Table striped>
                ...
                <tbody>
                    <tr><td className="wd-full-name text-nowrap">
                        ...
                        <td className="wd-total-activity">12:10:45</td></tr>
                </tbody>
                <tbody>
                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-total-activity">09:15:36</td></tr>
                </tbody>
                <tbody>
                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-total-activity">08:29:11</td></tr>
                </tbody>
                <tbody>
                    <tr><td className="wd-full-name text-nowrap">
                        <FaUserCircle className="me-2 fs-1 text-secondary" />
                        ...
                        <td className="wd-role">STUDENT</td>
                        <td className="wd-last-activity">2020-09-30</td>
                        <td className="wd-total-activity">11:19:03</td></tr>
                </tbody>
            </Table>
        </div>);
}
